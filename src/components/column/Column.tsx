...
const Column: React.FC<ColumnProps> = ({ 
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={`kanban-column flex-shrink-0 w-80 bg-gray-50 rounded-lg shadow-sm border border-gray-200 ${
    ...
    >
      ...
      <div className="p-4 min-h-96">
        ...
        <button
          ...
          className="w-full mt-4 py-3 text-gray-500 hover:text-gray-700 border border-dashed border-gray-300 rounded-lg hover:border-gray-400 hover:bg-gray-50 transition-all duration-200 flex items-center justify-center gap-2"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
